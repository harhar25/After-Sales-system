...
router.get('/scheduling-orders/:customerId', requireRole('SA'), getSchedulingOrder);
...
// 8.1 Billing Generation routes
router.post('/service-orders/:serviceOrderId/generate-billing', requireRole('SA'), generateBilling);
router.get('/billing/:billingId/details', requireRole('SA'), getBillingDetails);
router.post('/billing/:billingId/print', requireRole('SA'), printServiceBilling);
